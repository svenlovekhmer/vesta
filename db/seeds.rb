...
clients = [
  { first_name: "Marie",    last_name: "Laurent",  email: "marie.laurent@email.com" },
  { first_name: "Thomas",   last_name: "Moreau",   email: "thomas.moreau@email.com" },
  { first_name: "Isabelle", last_name: "Petit",    email: "isabelle.petit@email.com" },
  { first_name: "Nicolas",  last_name: "Bernard",  email: "nicolas.bernard@email.com" }
